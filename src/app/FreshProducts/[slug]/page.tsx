...
const Page = () => {
    ...
    const handleAddToCart = () => {
        if (newProduct) {
            ...
            addtoCart(id, 1, image, price, title, size, color);
            router.push('/Cart')
        }
    };
    ...
    return (
        <>
            {Open && <div className='bg-orange-600 relative top-16 z-40 shadow-lg text-[18px] text-white font-bold text-center p-4'>
                <h1>Only <span className='font-extrabold'>{newproducts?.availableqty}</span> left in Stock, Hurry Up!</h1>
            </div>}
            <section className="text-gray-600 mt-10 cursor-pointer body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <Image height={400} width={400} alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-top rounded" src={newproducts?.image ?? 'default-image-url'} />
